...
Vaes_key_expand_128::Vaes_key_expand_128(VerilatedContext* _vcontextp__, const char* _vcname__)
    : VerilatedModel{*_vcontextp__}
    , vlSymsp{new Vaes_key_expand_128__Syms(contextp(), _vcname__, this)}
...
Vaes_key_expand_128::Vaes_key_expand_128(const char* _vcname__)
    : Vaes_key_expand_128(Verilated::threadContextp(), _vcname__)
{
}
...
Vaes_key_expand_128::~Vaes_key_expand_128() {
    delete vlSymsp;
}
...
#endif  // VL_DEBUG
void Vaes_key_expand_128___024root___eval_static(Vaes_key_expand_128___024root* vlSelf);
void Vaes_key_expand_128___024root___eval_initial(Vaes_key_expand_128___024root* vlSelf);
void Vaes_key_expand_128___024root___eval_settle(Vaes_key_expand_128___024root* vlSelf);
void Vaes_key_expand_128___024root___eval(Vaes_key_expand_128___024root* vlSelf);

void Vaes_key_expand_128::eval_step() {
    VL_DEBUG_IF(VL_DBG_MSGF("+++++TOP Evaluate Vaes_key_expand_128::eval_step\n"); );
#ifdef VL_DEBUG
    // Debug assertions
    Vaes_key_expand_128___024root___eval_debug_assertions(&(vlSymsp->TOP));
#endif  // VL_DEBUG
    vlSymsp->__Vm_deleter.deleteAll();
    if (VL_UNLIKELY(!vlSymsp->__Vm_didInit)) {
        vlSymsp->__Vm_didInit = true;
        VL_DEBUG_IF(VL_DBG_MSGF("+ Initial\n"););
        Vaes_key_expand_128___024root___eval_static(&(vlSymsp->TOP));
        Vaes_key_expand_128___024root___eval_initial(&(vlSymsp->TOP));
        Vaes_key_expand_128___024root___eval_settle(&(vlSymsp->TOP));
    }
    VL_DEBUG_IF(VL_DBG_MSGF("+ Eval\n"););
    Vaes_key_expand_128___024root___eval(&(vlSymsp->TOP));
    // Evaluate cleanup
...
//============================================================
// Events and timing
bool Vaes_key_expand_128::eventsPending() { return false; }

uint64_t Vaes_key_expand_128::nextTimeSlot() {
...
const char* Vaes_key_expand_128::name() const {
    return vlSymsp->name();
}
...
void Vaes_key_expand_128___024root___eval_final(Vaes_key_expand_128___024root* vlSelf);

VL_ATTR_COLD void Vaes_key_expand_128::final() {
    Vaes_key_expand_128___024root___eval_final(&(vlSymsp->TOP));
}

//============================================================
// Implementations of abstract methods from VerilatedModel

const char* Vaes_key_expand_128::hierName() const { return vlSymsp->name(); }
const char* Vaes_key_expand_128::modelName() const { return "Vaes_key_expand_128"; }
unsigned Vaes_key_expand_128::threads() const { return 1; }
void Vaes_key_expand_128::prepareClone() const { contextp()->prepareClone(); }
void Vaes_key_expand_128::atClone() const {
